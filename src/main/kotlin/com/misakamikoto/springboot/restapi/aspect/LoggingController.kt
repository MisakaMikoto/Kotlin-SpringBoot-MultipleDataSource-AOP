...
class LoggingController {
    ...
    @Before("com.misakamikoto.springboot.restapi.aspect.pointcut.RestPointcut.get()")
    ...
    @Before("com.misakamikoto.springboot.restapi.aspect.pointcut.RestPointcut.post()")
    fun beforePostMapping(joinPoint: JoinPoint) {
        logger.info("==================== REST API CALL ====================")
        logger.info("Executing POST Type method : " + joinPoint.signature.name)
    }

    @Before("com.misakamikoto.springboot.restapi.aspect.pointcut.RestPointcut.put()")
    fun beforePutMapping(joinPoint: JoinPoint) {
        logger.info("==================== REST API CALL ====================")
        logger.info("Executing PUT Type method : " + joinPoint.signature.name)
    }

    @Before("com.misakamikoto.springboot.restapi.aspect.pointcut.RestPointcut.delete()")
